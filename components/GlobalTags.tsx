      ...
      <style
        dangerouslySetInnerHTML={{
          ...
          @font-face {
            ...
            src: url(/arquivos/MontblancType-Light.woff.css) format("woff");
            font-weight: 300;
            font-style: normal;
            font-display: swap
          }
          @font-face {
            font-family: Montblanc;
            src: url(/arquivos/MontblancType-Regular.woff.css) format("woff");
            font-weight: 400;
            font-style: normal;
            font-display: swap
          }
          @font-face {
            font-family: Montblanc;
            src: url(/arquivos/MontblancType-Bold.woff.css) format("woff");
            font-weight: 700;
            font-style: normal;
            font-display: swap
          }
